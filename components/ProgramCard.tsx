...
export function ProgramCard({ title, description, image, index = 0, href = "/programs" }: ProgramCardProps) {
  return (
    <motion.article
    ...
    >
      ...
      <div className="p-6">
        ...
        <Link
          href={href}
          className="mt-6 inline-flex rounded-full border border-[#5B2C83]/22 px-4 py-2 text-sm font-semibold text-[#5B2C83] transition hover:bg-[#E8DDF5]"
        >
          Learn More
        </Link>
      </div>
