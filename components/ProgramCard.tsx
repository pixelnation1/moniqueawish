...
export function ProgramCard({
  ...
  return (
    <Link href={href} className="block cursor-pointer">
      ...
      >
        <div className="image-skeleton relative h-44 overflow-hidden rounded-t-2xl sm:h-52 md:h-56 md:rounded-t-3xl">
          <Image
            key={image}
            src={image}
        ...
        <div className="p-4 sm:p-6">
          ...
          <p className="mt-3 line-clamp-3 text-sm leading-6 text-[#4D4D4D] sm:mt-4 sm:leading-7">
            {description}
          </p>
